                        ...
                        <Box>
                            <FormControl sx={{ minWidth: '10rem', mt: 2, mr: 1 }}>
                                ...
                                <Select
                                    ...
                                    value={sourceType}
                                    label="Source Type"
                                    onChange={(event) => setSourceType(event.target.value.split(' ').join(''))}
                                >
                            ...
                            <TextField
                                ...
                                autoFocus
                                value={sourceId}
                                onChange={(event) => setSourceId(event.target.value.split(' ').join(''))}
                            />
                            <FormControl sx={{ minWidth: '10rem', mt: 2, mr: 1 }}>
                                ...
                                <Select
                                    ...
                                    value={targetType}
                                    label="Target Type"
                                    onChange={(event) => setTargetType(event.target.value.split(' ').join(''))}
                                >
                                    <MenuItem value="Patient">Patient</MenuItem>
                                    <MenuItem value="Person">Person</MenuItem>
                                </Select>
                            ...
                            <TextField
                                ...
                                autoFocus
                                value={targetId}
                                onChange={(event) => setTargetId(event.target.value.split(' ').join(''))}
                            />
                        </Box>
