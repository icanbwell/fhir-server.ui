...
const PersonPatientLinkPage: React.FC = () => {
  ...
  const handleCreatePersonToPersonLink = async (event: React.FormEvent) => {
    event.preventDefault();
    await new AdminApi(fhirUrl).createPersonToPersonLink(
      bwellPersonId,
      externalPersonId,
    );
  };
  ...
  const handleRemovePersonToPersonLink = async (event: React.FormEvent) => {
    event.preventDefault();
    await new AdminApi(fhirUrl).removePersonToPersonLink(
      bwellPersonId,
      externalPersonId,
    );
  };
  ...
  const handleCreatePersonToPatientLink = async (event: React.FormEvent) => {
    event.preventDefault();
    await new AdminApi(fhirUrl).createPersonToPatientLink(
      externalPersonId,
      patientId,
    );
  };
