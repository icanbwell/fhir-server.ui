 ...
 * @constructor
 */
const IndexPage = ({ search, fhirUrl }: any) => {
    ...
    const context: any = useContext(EnvironmentContext);
    console.log(context, 'uiagsiudcvaiusd');
    ...
    function getBox() {
        ...
        return (
            <>
                ...
                {resources.map((fullResource: any, index: any) => {
